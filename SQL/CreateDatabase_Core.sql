...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[RentedShowHistory]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[RentedShowHistory]
GO
...
-- NOTE: NO FOREIGN KEYS. THIS DATA SHOULD EXIST PAST DELETION OF MEMBER, SHOW, PROVIDER, ETC.
